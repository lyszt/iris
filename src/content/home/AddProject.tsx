    ...
    return (
        <div>
            ...
            <div className="flex flex-row">
                <button onClick={() => setShowForm(true)} className="flex bg-gray-100 border-gray-200 border flex-row gap-2 mt-5 ml-5 mb-5 transition duration-100 hover:bg-gray-200 rounded active:bg-gray-200 w-[8%] justify-center items-center">

                    <span>Add project</span>
                </button>

                <button onClick={() => setShowForm(true)} className="flex bg-gray-100 border-gray-200 border flex-row gap-2 mt-5 mb-5 ml-1 p-3 transition duration-100 hover:bg-gray-200 rounded active:bg-gray-200 w-[8%] justify-center items-center">
